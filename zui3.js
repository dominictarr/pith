...
//beefy zui3.js --live --open --debug=false -- --fast --noparse=three.min.jsi &  crud-file-server
//:%!xclip -sel clip
//u
  ...
  var addDAGobj = {
    ...
    children:[
    {
      ...
      func: function foldtestparent (v) {
        var fpoaoldo = observe('foldavg/fpoaold')
...
var testTree = A.addJSONAtom(addDAGobj);
